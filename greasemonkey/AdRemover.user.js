...
// @name       D3GO
// @version    8.5
// @description  Daljinski za D3GO
// @match http://*.d3go.tv/*
// @match http://www.d3go.tv/*
...
/*  ============================================= 20150902 MarkoN ===========================================================*/
var trenutni_kanal = 0;
setTimeout(function(){ 
	console.log("Start...");
	var ukupno_kanala = $("#PlayerChannelsContainer > div").length;
	console.log("Ukupno: kanala"+ukupno_kanala);
$(".ChannelButton, .ChannelButtonCatchUp").on("click", function(e){
		var _e = ($(this).attr("id")).split("_");
		console.log(_e);
		trenutni_kanal = _e[1];
	});
	 
/*postavljanje novih divova GORE i DOLE*/	
var para = document.createElement("span");
para.setAttribute("id", "dolebre");
var node = document.createTextNode("dole");
para.appendChild(node);

var element = document.getElementById("PlayerChannels");
var child = document.getElementById("PlayerNavDown");
element.insertBefore(para,child);
	
	var para2 = document.createElement("span");
para2.setAttribute("id", "gorebrebre");
var node2 = document.createTextNode("gore");
para2.appendChild(node2);

var element = document.getElementById("PlayerChannels");
var child = document.getElementById("PlayerNavUp");
element.insertBefore(para2,child);

/*dodeljivanje tastera za promenu kanala*/
	console.log("bla11");
	document.addEventListener("keyup", function(e){
	console.log(e.keyCode);
	switch(e.keyCode){
		case 83:
			if(trenutni_kanal<ukupno_kanala){
		trenutni_kanal++;
		var lt = document.getElementById('ChannelButton_'+trenutni_kanal);
   lt.click();
	}
			break;
		case 87:
...
c);"function"===typeof define&&define.amd&&define(function(){return c})})(window,document);
	...
	/*dodavavanje novih kanala*/
	var newHTML         = document.createElement ('div');
newHTML.innerHTML   = '             \
    <div id="gmSomeID">             \
        <p><a id="balkanika" href="http://mylittleworkspace.com/aca/d3-primer/vlc.php?streamtest=http://edge2.vektor.net/vektor_live/balkanika.stream/playlist.m3u8" target="_blank">BALKANIKA</a></p>       \
<p class="planeta"><a id="planeta" href="http://bg-gledai.tv/online-planeta-tv" target="_blank">PLANETA</a></p>                        \
    </div>                          \
';
...
document.body.appendChild (newHTML);
	...
	function balkanika(url)
  {window.location = url;}
  Mousetrap.bind("1", function() {
    balkanika(document.getElementById("balkanika").href);
  });
  
  function planeta(url)
  {window.location = url;}
  Mousetrap.bind("2", function() {
    planeta(document.getElementById("planeta").href);
  });
	
	
/* menjanje kanala na osnovu trenutnog fix */	
	$(".ChannelButton, .ChannelButtonCatchUp").each(function(e){
			console.log("@1")
		var btn_str = $(this).attr('style');
		
		if(btn_str!==undefined){
			console.log(btn_str);
			if(btn_str.indexOf("channel_button_nc_hover")>0 || btn_str.indexOf("channel_button_hover")>0){
			var _e = ($(this).attr("id")).split("_");
			console.log(_e);
			trenutni_kanal = _e[1];
			}
